...
void Shop(double& money, int& weapon, int& upgrade1, int& upgrade2, double& cost, int& pet, class pet2 PIKACHU)
{
...
void start_game(double& money, int& weapon, int& pet, double& cost, int& upgrade1, int& upgrade2, class boss tom, class  boss ivan, class pet2 PIKACHU)
{
	const auto n = 1;
	std::string m;
	while (n > -10)
